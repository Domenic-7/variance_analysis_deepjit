...
def mini_batches_train(X_msg, X_code, Y, mini_batch_size=64):
    m = X_msg.shape[0]  # number of training examples
    mini_batches = list()
    ...
    for k in range(0, num_complete_minibatches):
        ...
        mini_batch = (mini_batch_X_msg, mini_batch_X_code, mini_batch_Y)
        mini_batches.append(mini_batch)
    #print('Batch [1]: ' + str(mini_batches[1]))
    #print('Batch [2]: ' + str(mini_batches[2]))
    #print('Batch [3]: ' + str(mini_batches[3]))
    return mini_batches
